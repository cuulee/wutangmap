...
@sans: 'DIN Offc Pro Regular';
@sans_md: 'DIN Offc Pro Medium';
@sans_bd: 'DIN Offc Pro Bold';
@sans_it: 'DIN Offc Pro Italic';
@sans_bdit: 'DIN Offc Pro Black Italic';
...
#admin[maritime=0][zoom>=5][admin_level>2]{
  line-join: round;
  line-color: @fill5;
  line-width: 1;
  line-dasharray: 3,2;
...
#water {
  ...
  ::fill {
    ...
    // fill from ::shadow.
    polygon-pattern-file: url('img/Wu-Tang_Clan.gif');
    polygon-fill: @land;
    comp-op: soft-light;
